...
const vehicleApi = {
  getVehicles: async (params: VehicleListParams = {}) => {
    try {
      const response = await axiosInstance.get<VehicleListResponse>('/vehicles', { params });
  ...
  getUserVehicles: async (params: VehicleListParams = {}) => {
    try {
      const response = await axiosInstance.get<VehicleListResponse>('/vehicles/user', { params });
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  createVehicle: async (data: CreateVehicleRequest) => {
    try {
      const response = await axiosInstance.post<VehicleResponse>('/vehicles', data);
  ...
  getVehicleByPlateNumber: async (plateNumber: string) => {
    try {
      const response = await axiosInstance.get<VehicleResponse>(`/vehicles/plate_number/${plateNumber}`);
      return response.data.data;
    } catch (error) {
      throw error;
    }
  ...
  updateVehicle: async (id: string, data: UpdateVehicleRequest) => {
    try {
      const response = await axiosInstance.patch<VehicleResponse>(`/vehicles/${id}`, data);
      return response.data.data;
    } catch (error) {
      throw error;
    }
